...
class SignIn extends Component{
    ...
    return(
        <div>
            <article className="br3 ba b--black-10 mt6 mb1 w-100 w-50-m w-25-l mw6 shadow-5 center" style={{backgroundColor: "whitesmoke"}}>
            ...
            <div className="measure center">
                ...
                <div className="mv3">
                    <div className="inputBox">
                    <ion-icon className="lockIcon" size="large" name="lock"></ion-icon>
